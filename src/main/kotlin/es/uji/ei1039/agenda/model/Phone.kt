...
sealed class Phone(
    ...
    val isNew: Boolean by lazy { this is Phone.New }
    ...
    companion object {
        fun empty(): Phone = Phone.New()
        fun empty(idBlacklist: Set<Int>): Phone = Phone.New((-1 downTo Int.MIN_VALUE).first { it !in idBlacklist })
        fun create(id: Int, phone: String, label: Phone.Label): Phone = Phone.Existing(id, phone, label)
    }
